...
public class Resultat { // classe pour stocker les différents résultats des algorithmes sous un même type
    ...
    private HashMap<String, HashMap<String, Station>> matricePere;
    private HashMap<String, Long> matriceDistanceBF;
    private HashMap<String, Station> matricePereBF;
    ...
    public HashMap<String, HashMap<String, Station>> getMatricePere() {
        System.out.println("DEBUG: matrice pere : " + matricePere);
        return matricePere;
    }

    public void setMatricePere(HashMap<String, HashMap<String, Station>> matricePere) {
    ...
    public HashMap<String, Station> getMatricePereBF() {
        return matricePereBF;
    }

    public void setMatricePereBF(HashMap<String, Station> matricePereBF) {
